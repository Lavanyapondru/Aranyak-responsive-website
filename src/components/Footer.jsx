                    ...
                    <div className="row footer">
                        <div className="col-lg-4">
                            ...
                            <div className="links">
                                ...
                                <li><a href="catalog" className="text-decoration-none text-light">Catalog</a></li>
                ...
                <div className="footerclr">
                    <div className="container">
                        <div className="rights text-light">
                            <h5>Made by <a href="#" className=" heart text-decoration-none text-light">Themewagon</a>. All Copyrights Reserved @2024</h5>
